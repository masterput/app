          ...
          <a href="<?php echo base_url() ?>index.php/dashboard/logout" class="list-group-item list-group-item-action list-group-item-danger" style="color: #ab1340;">Logout</a> 
			...
			<div class="col-md-9">
				<div class="card">
					...
					<div class="card-body">
						<form action="<?php echo base_url() ?>index.php/admin/simpan" method="POST">
							<div class="form-group">
								<label>USERNAME</label>
								<input type="text" name="username" placeholder="Masukkan Username" class="form-control"> </div>
							<div class="form-group">
								<label>EMAIL</label>
								<input type="text" name="email" placeholder="Masukkan Email" class="form-control"> </div>
							<div class="form-group">
								<label>PASSWORD</label>
								<input type="password" name="password" placeholder="Masukkan Password" class="form-control"> </div>
							<div class="form-group">
